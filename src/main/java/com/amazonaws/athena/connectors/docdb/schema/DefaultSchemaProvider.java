...
public class DefaultSchemaProvider implements SchemaProvider {
    ...
    private static Field mergeListField(String fieldName, Field curParentField, Field newParentField) {
        ...
        if (newInnerType == Types.MinorType.LIST && curInnerType == Types.MinorType.LIST) {
            ...
            logger.warn("Encountered a mixed-type list field[{}] {} vs {}, defaulting to String.",
    ...
    private static Field getArrowField(String key, Object value) {
        if (value instanceof String) {
            ...
            if (((List<?>) value).isEmpty()) {
                logger.warn("Encountered an empty List/Array for field[{}], defaulting to List<String> due to type erasure.", key);
     ...
     * that you use AWS Glue to define a schema for tables which may have such
